    ...
    <div className="bg-white rounded-[44px] border border-slate-200 shadow-2xl overflow-hidden animate-page-enter">
      <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
        <div>
          ...
          <p className="text-sm text-slate-500 font-bold uppercase tracking-widest mt-1 opacity-60">Suara Warga RT 05 Gayam</p>
        </div>
      ...
      <div className="p-10 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Kategori Masalah</label>
            <select 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Subjek Aduan</label>
            <input 
              type="text" 
              className="w-full bg-slate-900 text-white rounded-2xl px-6 py-4 focus:ring-2 focus:ring-rose-500 outline-none font-black placeholder-slate-600"
              placeholder="Contoh: Perbaikan Got Blok A"
        ...
        <div className="space-y-2 relative">
          ...
          >
            {isPolishing ? '...' : '✨ Rapikan Narasi AI'}
          </button>
        </div>

        <div className="space-y-2">
          <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Bukti Visual (Opsional)</label>
          <div 
          ...
          >
            {previewImage ? (
              ...
              <>
                ...
                <p className="text-xs font-black text-slate-700 uppercase">Lampirkan Bukti Foto</p>
              </>
            )}
          </div>
      ...
      <div className="p-10 bg-slate-50 flex gap-4">
        ...
        <button 
          ...
          disabled={!formData.residentName || !formData.subject || !formData.description}
